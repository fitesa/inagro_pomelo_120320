...
var style_IndicedeHumedad_1 = function(feature, resolution){
    ...
    if (value >= -0.120479 && value <= -0.039256) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.039256 && value <= 0.041967) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.041967 && value <= 0.123190) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.123190 && value <= 0.204414) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.204414 && value <= 0.285637) {
            style = [ new ol.style.Style({
